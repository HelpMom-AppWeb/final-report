...
|---------|------------|--------------------------------------------------------------------------------------------------|------------------------------|
| TB1     | 2025/04/23 | - Camila Reyes<br>Gabriel Rivera<br> - Stephano Espinoza<br> - Gabriel Mamani<br> - Romina Maita | - Capítulo I: Introducción<br>- Capítulo II: Requirements Elicitation & Analysis<br>- Capítulo III: Requirements Specification<br>- Capítulo IV: Product Design<br>- Avance del Capítulo V: Product Implementation, Validation & Deployment hasta el punto 5.2.1.8<br>- Avance de Conclusiones, Bibliografía y Anexos<br>- Avance del Landing Page |
| TP      | 2025/04/26 | - Camila Reyes<br>Gabriel Rivera<br> - Stephano Espinoza<br> - Gabriel Mamani<br> - Romina Maita | - Correcciones del TB1<br>- Sprint 2: Landing Page finalizado<br>- Primera versión de la Web Application<br>- Capítulo V: Sprint Planning 2, Backlog 2 y evidencias<br>- Reflexiones de colaboración |
| MVP     | 2025/05/15 | - Camila Reyes<br>Gabriel Rivera<br> - Stephano Espinoza<br> - Gabriel Mamani<br> - Romina Maita  | - Versión Mínima Viable del Producto<br>- Funcionalidades core implementadas<br>- Primer despliegue en entorno de pruebas<br>- Validación inicial con usuarios |
| TB2     | 2025/06/18 | - Camila Reyes<br>Gabriel Rivera<br> - Stephano Espinoza<br> - Gabriel Mamani<br> - Romina Maita  | - Sprint 3: Implementación de features avanzadas<br>- Entrevistas de validación<br>- Evaluaciones heurísticas<br>- Video About-the-Product |
| RC1     | 2025/06/25 |  - Camila Reyes<br>Gabriel Rivera<br> - Stephano Espinoza<br> - Gabriel Mamani<br> - Romina Maita   | - Corrección de observaciones del TB2<br>- Optimización de UI/UX<br>- Pruebas de carga<br>- Documentación técnica de APIs |
| RC2     | 2025/06/30 | - Camila Reyes<br>Gabriel Rivera<br> - Stephano Espinoza<br> - Gabriel Mamani<br> - Romina Maita  | - Fix de bugs críticos<br>- Pruebas de usabilidad finales<br>- Ajustes de diseño responsivo<br>- Preparación para entrega final |
| TF      | 2025/07/05 |  - Camila Reyes<br>Gabriel Rivera<br> - Stephano Espinoza<br> - Gabriel Mamani<br> - Romina Maita           | **Versión Final**<br>- Implementación completa de todos los bounded contexts<br>- Validación final con usuarios<br>- Video demo final<br>- Repositorios y documentación técnica finalizados |
...
Entrega TF:
Para la entrega final, se hicieron correciones al informe y se realizaron pruebas de usabilidad. Se utilizó el canal de discord para comunicarnos y resolver dudas.
A continuación se muestran los analíticos de colaboración del equipo:

![img_7.png](img_7.png)

Correcciones realizadas por los integrantes del equipo:

| Integrante        | Contribuciones al Informe Final del Proyecto                                                                                                                                                 |
|-------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Camila Reyes      | Desarrollo del Template Spring, Preparación de la Evidencia de Despliegue, Corrección de Imágenes del documento, Elaboración de las Historias de Usuario, y Diseño de la Persona de Usuario. |
| Stephano Espinoza | Ejecución de la Modificación de Imágenes para mejorar la estética, y Definición clara del Objetivo del Sprint.                                                                               |
| Gabriel Rivera    | Documentación exhaustiva de los Servicios implementados en el proyecto.                                                                                                                      |
| Gabriel Mamani    | Realización de mejoras significativas en el diseño y presentación de la Carátula del informe.                                                                                                |
| Romina Maita      | Revisión y Corrección de Insights clave, así como la Documentación General del Proyecto.                                                                                                     |
