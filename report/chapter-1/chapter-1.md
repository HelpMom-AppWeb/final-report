...
- Logo de la Startup
  <img src="/assets/logoWebExpert.png" width="300"/>
- Logo de la aplicacion web
  <img src="/assets/HelpMomLogo.png" width="300"/>
...
1. <strong>Plataforma unificada</strong>: Integrar en una sola app:<br>
  • Monitoreo de signos vitales y crecimiento del bebé (prenatal/postnatal).<br>
  • Historial médico digital accesible para doctores y usuarias.<br>
  • Alertas personalizadas (medicamentos, citas).<br><br>
2. <strong>Contenido certificado</strong>: Biblioteca con artículos, videos y guías avaladas por obstetras.<br><br>
3. <strong>Telemedicina</strong>: Conexión directa con especialistas para consultas urgentes o seguimiento.<br><br>
4. <strong>Privacidad</strong>: Encriptación de datos médicos y cumplimiento de normativas locales.<br><br>
...
1. <strong>Adopción</strong>: Aumento de usuarias activas (gestantes) y profesionales (doctores) registrados.<br><br>
2. <strong>Retención</strong>: Uso continuo de la app durante todo el embarazo y postparto.<br><br>
3. <strong>Satisfacción</strong>: Reducción de ansiedad reportada por usuarias.<br><br>
4. <strong>Impacto clínico</strong>: Mejora en adherencia a controles médicos (métricas de citas cumplidas).<br><br>
...
1. <strong>Gestantes</strong> (25-35 años): Principalmente primerizas que buscan información confiable y seguimiento médico.<br><br>
2. <strong>Doctores</strong> (22-40 años): Necesitan acceso remoto a historiales médicos y herramientas para gestionar pacientes.<br><br>
</td>

<td>
<strong>User Outcomes & Benefits</strong><br><br>
1. <strong>Reducción de ansiedad</strong>: Acceso a información médica validada y apoyo profesional 24/7.<br><br>
2. <strong>Autogestión de la salud</strong>: Mayor control sobre su salud y la del bebé mediante datos en tiempo real.<br><br>
3. <strong>Eficiencia</strong>: Para obstetras, optimización de tiempo en consultas y seguimiento.<br><br>
4. <strong>Prevención</strong>: Detección temprana de riesgos mediante alertas personalizadas.<br><br>
...
1. Creemos que al integrar monitoreo médico y contenido validado, reduciremos la ansiedad en gestantes.<br><br>
2. Creemos que la telemedicina aumentará la adherencia a controles prenatales.<br><br>
3. Creemos que la seguridad de datos incrementará la confianza y adopción.<br><br>
4. Creemos que una interfaz intuitiva mejorará la retención.<br><br>
