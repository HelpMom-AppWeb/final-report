...
|---------------|--------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| EP1           | Información de StartUp   | Como visitante, quiero conocer información sobre la startup para entender su propósito y confiar en sus servicios.                                                                                                       | Dado que el usuario navega a la sección de servicios, entonces se muestra una descripción clara de lo que ofrece WebExpert.                                                                                                                                      |
| EP2           | Sobre el Producto        | Como visitante, quiero conocer detalles del producto para evaluar si satisface mis necesidades.                                                                                                                        | Dado que el usuario busca funcionalidades, entonces se listan claramente las características principales de HelpMom.                                                                                                                                        |
| EP3           | Planes y Suscripciones   | Como visitante, quiero conocer los planes disponibles para decidir si suscribirme.                                                                                                                                     | Dado que el usuario ve los planes, entonces se detallan las características y el costo de cada plan (mensual/anual).                                                                                                                                      |
| EP4           | Preguntas frecuentes     | Como visitante, quiero acceder a preguntas frecuentes para resolver dudas rápidamente.                                                                                                                                 | Dado que el usuario busca una pregunta específica, entonces puede encontrarla fácilmente a través de categorías o una barra de búsqueda.                                                                                                                 |
| EP5           | Contacto                 | Como visitante, quiero contactar al equipo de la startup para obtener asistencia personalizada.                                                                                                                          | Dado que el usuario envía un mensaje a través del formulario de contacto, entonces recibe una confirmación de envío.                                                                                                                                         |
| ep1           | Ingreso de datos médicos | Como doctor quiero ingresar información médica relevante para que se mantenga actualizado el historial clínico del embarazo y la salud del bebé.                                                                        | Dado que el doctor está realiza en una consulta médica, cuando ingresa nuevos datos clínicos, entonces estos deben guardarse en el historial médico digital del usuario.                                                                                   |
| ep2           | Gestionar datos personales | Como usuario de la plataforma, quiero poder registrar y actualizar mis datos personales para asegurarme de que mi información esté siempre completa y correcta.                                                        | Dado que los datos personales fueron editados correctamente, cuando se actualiza la página, entonces se mostrará la información nueva.                                                                                                                     |
| ep3           | Comunicación personalizada | Como madre gestante, quiero comunicarme directamente con un profesional de salud para recibir orientación personalizada y resolver mis dudas.                                                                          | Dado que existe una conversación activa, cuando se envía un nuevo mensaje, entonces este debe aparecer instantáneamente en el chat.                                                                                                                     |
| ep4           | Soporte al usuario       | Como usuario, quiero tener acceso a soporte técnico y funcional para resolver problemas relacionados con el uso de la plataforma.                                                                                         | Dado que se completó el formulario de soporte, cuando se envía el ticket, entonces este se almacenará en la base de datos y se notificará al equipo de soporte.                                                                                         |
| ep5           | Monitoreo de bebés       | Como madre gestante, quiero registrar y visualizar la información del desarrollo de mi bebé para llevar un seguimiento de su crecimiento y bienestar.                                                                    | Dado que se ingresa un nuevo dato de crecimiento, cuando se guarda la información, entonces esta se refleja en el gráfico de evolución.                                                                                                               |
| ep6           | Historial de citas médicas | Como usuaria, quiero visualizar el historial de mis citas médicas para consultar fácilmente las fechas, profesionales y resultados de consultas anteriores.                                                           | Dado que el usuario accede a la sección de historial de citas médicas, entonces se muestran todas sus citas anteriores.                                                                                                                               |
| ep7           | Calendario de citas médicas | Como usuaria, quiero visualizar mis citas médicas programadas y recibir recordatorios para no perder ningún control importante.                                                                                     | Dado que el usuario accede al calendario de citas, entonces puede visualizar las citas programadas de forma clara (ej. por día, semana, mes).                                                                                                          |
| ep8           | Gestión de suscripción   | Como usuaria, quiero poder ver mi plan de suscripción actual, modificarlo o cancelarlo de forma sencilla y transparente.                                                                                               | Dado que el usuario accede a la sección de gestión de suscripción, entonces puede ver su plan actual y la fecha de vencimiento.                                                                                                                        |
