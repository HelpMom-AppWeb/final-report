...
| HU19       | Registro de medicamento      | Como doctor, quiero registrar el nombre y cantidad de un medicamento para mejorar diagnósticos.          | Dado que el doctor ingresa texto no vacio y un numero no vacio diferente de 0, cuando desee visualizar las recetas guardadas, entonces el sistema permite el registro del medicamento. |
